...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "guyzyl-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/guyzyl"
  #   chef.validation_client_name = "guyzyl-validator"
  #   chef.validation_key_path = ".chef/guyzyl-validator.pem"
  # end
end
